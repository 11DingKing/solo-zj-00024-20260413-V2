...
public interface TransactionService {
    ...
    byte[] exportTransactionsToCsv(String email, String searchKey, String transactionType, java.time.LocalDate startDate, java.time.LocalDate endDate) throws TransactionServiceLogicException;
